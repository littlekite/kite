...
<head>
	...
	<link rel="stylesheet" href="<?php echo $admin; ?>css/index.css" media="all" />
</head>
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
			...
			<div class="layui-main mag0">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="<?php echo $admin; ?>images/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">驊驊龔頾</cite></a>
						<dl class="layui-nav-child">
							<dd><a href="javascript:;" data-url="<?php echo $admin; ?>page/user/userInfo.html"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
							<dd><a href="javascript:;" data-url="<?php echo $admin; ?>page/user/changePwd.html"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
							<dd><a href="javascript:;" class="showNotice"><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span class="layui-badge-dot"></span></a></dd>
							<dd pc><a href="javascript:;" class="functionSetting"><i class="layui-icon">&#xe620;</i><cite>功能设定</cite><span class="layui-badge-dot"></span></a></dd>
							<dd pc><a href="javascript:;" class="changeSkin"><i class="layui-icon">&#xe61b;</i><cite>更换皮肤</cite></a></dd>
							<dd><a href="<?php echo $admin; ?>page/login/login.html" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="<?php echo $admin; ?>images/face.jpg" class="userAvatar"></a>
			...
			<div class="navBar layui-side-scroll" id="navBar">
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-this">
						<a href="javascript:;" data-url="<?php echo $admin; ?>page/main.html"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="<?php echo $admin; ?>page/main.html"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" src="<?php echo $admin; ?>layui/layui.js"></script>
	<script type="text/javascript" src="<?php echo $admin; ?>js/index.js"></script>
	<script type="text/javascript" src="<?php echo $admin; ?>js/cache.js"></script>
</body>
</html>