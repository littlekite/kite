...
namespace core\tpcl\BaconQrCode\Renderer\Image;

use core\tpcl\BaconQrCode\Encoder\QrCode;
use core\tpcl\BaconQrCode\Renderer\Color;
use core\tpcl\BaconQrCode\Renderer\Image\Decorator\DecoratorInterface;
use core\tpcl\BaconQrCode\Exception;

/**
 * Image renderer, supporting multiple backends.
 */
abstract class AbstractRenderer implements \core\tpcl\BaconQrCode\Renderer\RendererInterface
{
    /**
